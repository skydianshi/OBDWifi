...
public enum AvailableCommandNames {
    AIR_INTAKE_TEMP("Air Intake Temperature"), AMBIENT_AIR_TEMP(
            ...
            "Engine Runtime"), ENGINE_RPM("Engine RPM"), SPEED("Vehicle Speed"), MAF(
            ...
            "Fuel Economy With MAF"), FUEL_ECONOMY_WITHOUT_MAF(
            "Fuel Economy Without MAF"), TIMING_ADVANCE("Timing Advance"), DTC_NUMBER(
